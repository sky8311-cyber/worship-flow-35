...
const SetBuilder = () => {
  ...
  // Permission checks moved to SetBuilderGuard (prevents redirect/refresh flicker on re-renders)
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-1 space-y-4">
              {/* ... keep existing code (worship info cards, palette, positions manager) */}
              {/* NOTE: this block is intentionally unchanged; only wrapper moved */}
            </div>

            {/* Main Content - Items List */}
            <div className="lg:col-span-3">
              {/* ... keep existing code (items list, dialogs, collaborators, etc.) */}
            </div>
          </div>
        </div>
