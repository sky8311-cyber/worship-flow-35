        ...
        <div className="fixed inset-0 bg-[#faf7f2] dark:bg-background z-50 flex flex-col overflow-hidden relative">
          ...
          {isMobile && (
            <Sheet open={mobileAptOpen} onOpenChange={setMobileAptOpen}>
              <SheetContent side="bottom" className="h-[93dvh] max-h-[93dvh] p-0 rounded-t-2xl overflow-hidden flex flex-col [&>button:last-child]:top-2 [&>button:last-child]:right-3"> className="h-[93dvh] max-h-[93dvh] p-0 rounded-t-2xl overflow-hidden flex flex-col [&>button:last-child]:top-2 [&>button:last-child]:right-3"> [&>button:last-child]:top-2 [&>button:last-child]:right-3">
