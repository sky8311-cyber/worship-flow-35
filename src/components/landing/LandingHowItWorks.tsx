...
export const LandingHowItWorks = () => {
  ...
  return <section id="how-it-works" className="py-32 bg-accent/5">
...
이렇게 달라집니다.                             
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={viewportOptions} variants={staggerContainer} className="relative max-w-5xl mx-auto">
          {/* Mobile/Tablet: Vertical Timeline */}
          <div className="lg:hidden space-y-8">
            {steps.map((step, index) => <motion.div key={index} variants={staggerItem} className="relative pl-12">
                {/* Connection line */}
                {index < steps.length - 1 && <div className="absolute left-6 top-16 bottom-0 w-0.5 bg-border -translate-x-1/2" />}
          ...
          <div className="hidden lg:block">
            ...
            <div className="grid grid-cols-4 gap-6">
              {steps.map((step, index) => <motion.div key={index} variants={staggerItem} className="relative">
