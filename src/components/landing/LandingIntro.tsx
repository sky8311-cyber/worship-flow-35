...
export const LandingIntro = () => {
  ...
  return <section id="intro" className="py-32 bg-accent/5">
...
함께 나눌 수 있게 돕는 통합 플랫폼입니다.
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={viewportOptions} variants={staggerContainer} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pillars.map((pillar, index) => <motion.div key={index} variants={staggerItem} className="group p-8 bg-card border border-border rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
