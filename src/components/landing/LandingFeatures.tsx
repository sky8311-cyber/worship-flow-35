        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group p-8 bg-card border border-border rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 hover:scale-105"
            >
              ...
              {feature.subtitle && (
                <p className="text-sm text-primary/70 italic border-l-2 border-primary/30 pl-4">
                  {feature.subtitle}
                </p>
              )}
            </motion.div>
