...
const InstituteCourses = lazyWithRetry(() => import("./pages/InstituteCourses"));
const InstituteAbout = lazyWithRetry(() => import("./pages/InstituteAbout"));
        ...
        <MusicPlayerProvider>
          <SongCartProvider>
            ...
            <Routes>
              ...
              <Route path="/institute/courses" element={<ProtectedRoute><InstituteCourses /></ProtectedRoute>} />
              <Route path="/institute/about" element={<ProtectedRoute><InstituteAbout /></ProtectedRoute>} />
